    ...
    <div className="max-w-5xl mx-auto px-4 py-16">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4">
          Xin chào! Tôi là{" "}
          <span className="text-blue-600">Phùng Võ Quốc Hiển</span>
        </h1>
        <p className="text-xl text-gray-600 mb-2">
          Sinh viên Công nghệ Thông tin — Đại học Đà Lạt
        </p>
        <p className="text-lg text-gray-500 mb-8 max-w-2xl mx-auto">
          Frontend Lead với đam mê xây dựng giao diện web hiện đại và khám phá
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={skill}
              className="bg-gray-50 rounded-lg p-4 text-center hover:bg-blue-50 hover:text-blue-600 transition-colors cursor-default"
            >
              {skill}
            </div>
          ))}
      ...
      <div className="bg-blue-50 rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Chia sẻ kiến thức và kinh nghiệm về lập trình, công nghệ và cuộc sống
          sinh viên
        </p>
        <Link
          href="/blog"
